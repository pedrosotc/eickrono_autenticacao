    ...
    public SecurityFilterChain apiSecurity(HttpSecurity http,
        ...
        http.securityMatcher("/**")
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .hasAnyAuthority("SCOPE_vinculos:escrever", "ROLE_cliente")
                        .requestMatchers(HttpMethod.PUT, "/identidade/vinculos-sociais/avatar-preferido/upload")
                        .hasAnyAuthority("SCOPE_vinculos:escrever", "ROLE_cliente")
                        .requestMatchers(HttpMethod.PUT, "/api/conta/avatar-preferido")
                        .hasAnyAuthority("SCOPE_vinculos:escrever", "ROLE_cliente")
                        .requestMatchers(HttpMethod.PUT, "/api/conta/avatar-preferido/upload")
                        .hasAnyAuthority("SCOPE_vinculos:escrever", "ROLE_cliente")
                        .requestMatchers(HttpMethod.PUT, "/api/conta/redes-sociais/avatar-preferido")
                        .hasAnyAuthority("SCOPE_vinculos:escrever", "ROLE_cliente")
                        .requestMatchers(HttpMethod.PUT, "/api/conta/redes-sociais/avatar-preferido/upload")
                        .hasAnyAuthority("SCOPE_vinculos:escrever", "ROLE_cliente")
