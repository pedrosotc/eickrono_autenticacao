...
1. **Gerar tokens para testes** — acessar `http://localhost:8080/`, entrar no realm `eickrono` e criar/usar usuários para chamar as APIs via Swagger.
...
- **Endpoints OpenID Connect:**  
  - Descoberta: `http://localhost:8080/realms/eickrono/.well-known/openid-configuration`  
  - JWKs: `http://localhost:8080/realms/eickrono/protocol/openid-connect/certs`
